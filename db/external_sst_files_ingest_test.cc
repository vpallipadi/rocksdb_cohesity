...
TEST_F(ExternalSSTFileTest, Basic) {
  do {
    ...
    DestroyAndReopen(options);
    // Add file1..file3 with file2-file3 overlap and file3 having lower sequence
    // number.
    {
      std::vector<CustomIngSSTFileMetaData> custom_ingest_metadata_vec;
      custom_ingest_metadata_vec.push_back(
          CustomIngSSTFileMetaData(file1, 0, 20, 29));
      custom_ingest_metadata_vec.push_back(
          CustomIngSSTFileMetaData(file2, 0, 10, 19));
      custom_ingest_metadata_vec.push_back(
    ...
    DestroyAndReopen(options);
    // Add file1..file3 with file2-file3 overlap and file3 having higher
    // sequence number.
    {
      std::vector<CustomIngSSTFileMetaData> custom_ingest_metadata_vec;
      custom_ingest_metadata_vec.push_back(
          CustomIngSSTFileMetaData(file1, 0, 30, 39));
      custom_ingest_metadata_vec.push_back(
          CustomIngSSTFileMetaData(file2, 0, 10, 19));
      custom_ingest_metadata_vec.push_back(
          CustomIngSSTFileMetaData(file3, 0, 20, 29));
